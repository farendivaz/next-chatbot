...
const ruleBase = [
  ...
  [
    ...
    s[1],
    s[3],
    "Endoftalmitis, Keraritis, Panofthalmitis, Trombosis Sinus Cavernosus, Uveitis Akut atau Glaukoma Sekunder/Akut",
  ],
  [s[0], s[1], "Sindroma Mata Kering atau Uveitis Kronis"],
  [
    s[0],
    s[6],
    "Episkelritis, Hordeolum, Keratokonjungtivitis Flikte Nularis, Konjungtivitis Akut atau Pinguekulitis",
  ],
  [s[0], s[8], "Perdarahan Subkonjungtiva"],
  [
    s[0],
    s[9],
    "Blefaritis, Hemangioma, Iritasi, Gangguan Pembuluh Darah, Konjungtivitis Alergi atau Konjungtivitis Kronis",
  ],
  ...
  [
    ...
    s[3],
    s[11],
    "Abalsi Retina, Perdarahan Vitreus, Neuritis Optik, Kelainan Vaskular Retina, Hifema Spontan, Keracunan Metanol, Stroke Oksipitalis atau Malingering dan Histeria",
  ],
  [s[1], s[5], s[10], "Tumor, Strabismus atau Ophthalmopathy Thyroid"],
  [
    s[1],
    s[5],
    "Sikatrik Kornea, Kelainan Refraksi, Katarak, Uveitis Posterior, Glaukoma Sudut Terbuka Primer, Retinopati Diabetika & Hipertensi, Penyakit Macula, Papil Udema, Amblyopia, Neuropati Optik atau Retinisi Pigmentosa",
  ],
  ...
  [
    g[35],
    g[36],
    "Optic Neuritis (Papillitis, Retrobulbar neuritis atau Neuroretinitis)",
  ],
  ["end of second screening"],
...
export default function InferenceMachine() {
  ...
  let [lastValueWhenUserResponYes, setLastValueWhenUserResponYes] =
    useState("");
  let [lastValueWhenUserResponNo, setLastValueWhenUserResponNo] = useState("");
  let [totalSympthomWhenUserResponYes, setTotalSympthomWhenUserResponYes] =
    useState([]);
  let [totalSympthomWhenUserResponNo, setTotalSympthomWhenUserResponNo] =
    useState([]);
    ...
    // Screening Eye Disease
      ...
      if (userId) {
        if (
          ...
          axios.put(
            `https://express-mongoose-validator.herokuapp.com/api/users/${userId}`,
            {
  ...
  function Screening(input) {
    ...
    if (
      ...
      if (
        ...
        if (
          lastValueInRuleBase === "Sindroma Mata Kering atau Uveitis Kronis"
        ) {
        ...
        if (
          ...
          reply =
            "Diagnosis Tumor, Strabismus atau Ophthalmopathy Thyroid lebih lanjut perlu dilakukan dengan pemeriksaan oleh dokter spesialis mata";
          setDiagnoseResult(reply);
        }
        if (
          lastValueInRuleBase ===
        ...
        if (
          ...
          if (input === "y" || input === "ya") {
            ...
            // if ruleBase[i][j+1] is the last value in [i] array
              ...
              ruleBase[i][j + 1] === ruleBase[i][ruleBase[i].length - 1]
            ) {
              if (inputNow === "ya") {
                // 1st screening
                if (
                  ...
                  reply = `Kamu menjawab ya untuk ${
                    allYesReply.length + 1
                  } pertanyaan yang ditanyakan oleh bot.
                  Melalui skrining dicurigai kamu mengalami ${
                    totalSympthomWhenUserResponYes[
                      totalSympthomWhenUserResponYes.length - 1
                    ]
                  } gejala dari penyakit mata antara ${lastValueWhenUserResponYes}. 
                  Ketik atau tekan lanjut untuk melanjutkan skrining kedua.`;
                  setDiagnoseResult(reply);
                  setI(i);
                  setJ(j);
                  setLastValueInRuleBase(ruleBase[i][j + 1]);
                  setReplyBefore("");
                }
                // 2nd screening
                else {
                  if (j === 0) {
                    ...
                    } gejala dari penyakit mata ${lastValueWhenUserResponYes}. 
                    Silahkan konsultasikan hasil skrining ini dengan dokter spesialis mata terdekat untuk informasi lebih lanjut.`;
                    setDiagnoseResult(reply);
                    setI(i);
                    setJ(j);
              ...
              if (inputNow === "tidak") {
                ...
                if (
                  ...
                  Melalui skrining dicurigai kamu mengalami ${
                    totalSympthomWhenUserResponNo[
                      totalSympthomWhenUserResponNo.length - 1
                    ]
                  } gejala dari penyakit mata antara ${lastValueWhenUserResponNo}. 
                  Ketik atau tekan lanjut untuk melanjutkan skrining kedua.`;
                  setDiagnoseResult(reply);
                  setI(i);
                  setJ(j);
                ...
                // 2nd screening
                  ...
                  if (j === 0) {
                    ...
                    } gejala dari penyakit mata ${lastValueWhenUserResponNo}.
                    Silahkan konsultasikan hasil skrining ini dengan dokter spesialis mata terdekat untuk informasi lebih lanjut.`;
                    setDiagnoseResult(reply);
                    setI(i);
                    setJ(j);
            ...
            if (j === 0) {
                ...
                if (arr[findIndexInArray + 1] === "end of first screening") {
                  ...
                  for (let x = i; x < ruleBase.length; x++) {
                    if (ruleBase[x][0] === arr[findIndexInArray + 1]) {
                      ...
                      setJ(0);
                      setLastValueWhenUserResponNo(
                        ruleBase[x][ruleBase[x].length - 1]
                      );
                      setTotalSympthomWhenUserResponNo([
                        ...totalSympthomWhenUserResponNo,
                        ruleBase[x].length - 1,
              ...
              if (
                ...
                if (arr[findIndexInArray + 1] !== undefined) {
                  ...
                  if (
                    arr[findIndexInArray + 1] ===
                    ruleBase[i + 1][ruleBase[i + 1].length - 1]
                  ) {
                    // 1st screening
                    if (
                      ruleBase[i][j + 1] ===
                      ...
                      reply = `Kamu menjawab ya untuk ${
                        ...
                        Melalui skrining dicurigai kamu mengalami ${
                          allYesReply.length
                        } gejala dari penyakit mata antara ${
                        ruleBase[i + 1][ruleBase[i + 1].length - 1]
                      }.
                        Ketik atau tekan lanjut untuk melanjutkan skrining kedua.`;
                      setDiagnoseResult(reply);
                      setReplyBefore("");
                      setLastValueInRuleBase(ruleBase[i + 1][j]);
                    }
                    // 2nd screening
                    else {
                      reply = `Kamu menjawab ya untuk ${
