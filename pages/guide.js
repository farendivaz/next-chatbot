...
export default function Guide () {
  return(
    <div className='bg-blue-300 h-screen m-0 poppins'>
      ...
      <div 
        className='border-2 border-blue-300 hover:border-blue-600 mx-auto mt-0 mb-3 p-3 overflow-hidden rounded-lg hover:shadow-lg' 
        style={{paddingTop:'55px',maxWidth:'700px',width:'99%'}}
      >
